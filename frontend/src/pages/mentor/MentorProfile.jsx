  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-20">
      ...
      <div className="max-w-5xl mx-auto px-4 pt-10">
        ...
        {error && (
          <div className="mb-8 p-4 rounded-2xl bg-red-50 border border-red-100 text-red-700 flex items-center gap-3 animate-in fade-in slide-in-from-top-2">
                  ...
                  <div className="flex flex-col items-center">
                    <div className="relative group">
                      {profilePreview || mentor.profilePicture ? (
                        ...
                        <div className="w-32 h-32 rounded-[2.5rem] bg-gradient-to-br from-slate-800 to-slate-900 text-white flex items-center justify-center text-4xl font-bold border-4 border-white shadow-xl">
                    ...
                    <p className="mt-4 text-xs font-bold text-slate-500 uppercase tracking-widest text-center">Profile Photo</p>
                  </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          value={mentor.name || ""}
                          disabled
                          className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-slate-700 font-medium"
                        />
                      </div>
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder="+91 ..."
                          className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-medium"
                        />
                      </div>
                    </div>
                    <div className="space-y-2">
            ...
            <div className="bg-white rounded-[2rem] shadow-sm border border-slate-100 overflow-hidden">
              <div className="p-8">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h2 className="text-xl font-bold text-slate-900">Professional Background</h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-slate-700 uppercase tracking-wider ml-1 flex items-center gap-1.5">
                      Years of Experience
                  ...
                  <div className="md:col-span-2 space-y-2">
                    <label className="text-xs font-bold text-slate-700 uppercase tracking-wider ml-1">Bio / About You</label>
                    <textarea
                      rows={5}
                      value={bio}
                      onChange={(e) => setBio(e.target.value)}
                      placeholder="Share your journey, achievements, and how you want to help students..."
                      className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-medium resize-none"
                    />
                    <p className="text-[11px] text-slate-500 italic ml-1">* Be specific to help students understand your mentoring style.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-8">
                  ...
                  <div className="flex flex-col xl:flex-row gap-3">
                    <div className="relative flex-1 min-w-0">
                      <input
                        ...
                        className="w-full px-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-medium text-sm"
                      />
                    </div>
                    <button
                      type="button"
                      onClick={addSkill}
                      className="xl:w-auto w-full px-6 py-3.5 rounded-xl bg-slate-900 text-white font-bold text-sm hover:bg-slate-800 transition-all shadow-sm active:scale-95 whitespace-nowrap flex items-center justify-center gap-2"
                    >
                      <Plus size={16} />
                      Add Skill
                    </button>
                  ...
                  <div className="flex flex-wrap gap-2 min-h-[40px] w-full">
                    {skills.length > 0 ? (
                      skills.map((s) => (
                        <span
                          key={s}
                          className="inline-flex items-center gap-2 px-3.5 py-2 rounded-full bg-slate-50 text-slate-700 text-xs font-bold border border-slate-200 hover:border-blue-200 hover:bg-blue-50 transition-all group max-w-full overflow-hidden"
                        >
                      ...
                      <div className="w-full py-10 border-2 border-dashed border-slate-100 rounded-[1.5rem] flex flex-col items-center justify-center text-slate-400 gap-3 bg-slate-50/50">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[2rem] shadow-xl p-8 text-white space-y-6">
              ...
              <div className="pt-4 flex items-start gap-3 text-[11px] text-blue-100/70 leading-relaxed italic border-t border-white/10">
                ...
                <p>By submitting, you agree to our Mentor Guidelines and Community Standards.</p>
              </div>
            </div>
          </div>
        </div>
